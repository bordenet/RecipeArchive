...
RecipeArchive browser extensions can be distributed to friends for testing or published to official stores for public availability. Extensions integrate seamlessly with the complete RecipeArchive ecosystem including web and mobile applications.
...
_For technical implementation details, see the [Browser Extension PRD](../requirements/browser-extension.md) and [AWS Backend PRD](../requirements/aws-backend.md)._
