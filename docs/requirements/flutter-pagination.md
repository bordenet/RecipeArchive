...
> **Note**: Active implementation todos are tracked in the GitHub issue tracker; this document captures the product requirements rather than the current sprint plan.
