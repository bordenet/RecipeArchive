...
const ENV_CONFIG = {
  ...
  AWS_REGION:
    process.env.AWS_REGION || localStorage.getItem("AWS_REGION") || "us-west-2",

  // API Configuration
  API_BASE_URL:
    process.env.API_BASE_URL || localStorage.getItem("API_BASE_URL"),

  // Test credentials (development only)
  TEST_USER_EMAIL:
    process.env.TEST_USER_EMAIL || localStorage.getItem("TEST_USER_EMAIL"),
  TEST_USER_PASSWORD:
    process.env.TEST_USER_PASSWORD ||
    localStorage.getItem("TEST_USER_PASSWORD"),
};
...
const EXTENSION_CONFIG = {
  ...
  ENVIRONMENT:
    localStorage.getItem("recipeArchive.dev") === "true"
      ? "development"
      : "production",
  ...
  API: {
    ...
    production: {
      ...
      recipes: `${ENV_CONFIG.API_BASE_URL}/recipes`,
      diagnostics: `${ENV_CONFIG.API_BASE_URL}/diagnostics`,
