...
class _LoginScreenState extends ConsumerState<LoginScreen> {
  ...
  Future<void> _loadSavedCredentials() async {
    try {
      // Check for developer mode in secure storage (like extension approach)
      ...
      if (isDeveloperMode && devEmail != null && devPassword != null) {
        // Developer mode: use stored developer credentials
        setState(() {
        ...
        // Auto-login only in developer mode and if explicitly enabled
        if (autoLoginEnabled && !_isLoading) {
      ...
      // Production mode: load saved user credentials
      ...
      if (savedEmail != null && savedPassword != null && rememberMe) {
        ...
        // Clear fields for new users (no default credentials in production)
        setState(() {
      ...
      // Error loading saved credentials, clear everything for security
      setState(() {
        _emailController.clear();
        _passwordController.clear();
        _rememberMe = false;
