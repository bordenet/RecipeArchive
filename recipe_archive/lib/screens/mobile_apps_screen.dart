              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Access Recipe Archive on your mobile device through our Progressive Web App. Works on both iOS and Android with offline capabilities and app-like experience.',
...
1. Open Safari and go to the Recipe Archive web app
2. Tap the Share button (square with arrow)
3. Scroll down and tap "Add to Home Screen"
4. Tap "Add" to confirm

🤖 On Android (Chrome):
1. Open Chrome and go to the Recipe Archive web app
