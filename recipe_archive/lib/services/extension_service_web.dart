  ...
  Future<ExtensionVersions?> getAvailableVersions() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        // Failed to load extension versions: HTTP ${response.statusCode}
        // Response body: ${response.body}
      }

      return null;
    } catch (e) {
      // Error loading extension versions: $e
      return null;
    }
  }
...
6. The Recipe Archive extension will appear in your toolbar
        ''';
...
8. Find Recipe Archive and enable it
        ''';
