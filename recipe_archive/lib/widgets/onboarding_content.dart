...
class OnboardingContent extends StatelessWidget {
          ...
          children: [
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildStepWithLink(
                      ...
                      ' to start capturing recipes with a single click.',
                      Icons.download,
                      () => _navigateToExtensions(context),
                    ),
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                onPressed: () => _navigateToExtensions(context),
  ...
  Widget _buildStepWithLink(BuildContext context, String number, String title, String linkText, String remainingText, IconData icon, VoidCallback onTap) {
    return Row(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Container(
  ...
  void _navigateToExtensions(BuildContext context) {
