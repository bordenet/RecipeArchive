...
#
# This script sets up monitoring to help you stay within AWS Free Tier limits.
# It creates an SNS topic, CloudWatch alarms, and an AWS Budget.
#
# USAGE:
#   ./setup-aws-billing-controls.sh
#
# DEPENDENCIES:
#   - AWS CLI
#
...
SNS_TOPIC_ARN=$(aws sns create-topic --name freetier-alerts --region us-east-1 --output text --query TopicArn 2> /tmp/setup-aws-billing-controls.log || echo "")
...
aws budgets create-budget \
    ...
    2> /tmp/setup-aws-billing-controls.log && print_success "Free Tier budget created successfully!" || print_warning "Budget creation failed. You may need to create it manually in the AWS Console. See /tmp/setup-aws-billing-controls.log for details."
