...
readonly S3_BUCKET="${S3_WEB_APP_BUCKET:-recipearchive-web-app-<ACCOUNT_ID>}"
readonly CLOUDFRONT_DISTRIBUTION_ID="${CLOUDFRONT_DISTRIBUTION_ID:-<CLOUDFRONT_DISTRIBUTION_ID>}"
