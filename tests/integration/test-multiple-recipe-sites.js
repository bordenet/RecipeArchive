...
async function testMultipleRecipeSites() {
    ...
    try {
      ...
      const result = {
        ...
        features: {
          ...
          hasImageObject:
            extractionResult?.rawImageData &&
            typeof extractionResult.rawImageData === "object" &&
            extractionResult.rawImageData["@type"] === "ImageObject",
  ...
  console.log(
    `✅ Successful extractions: ${successful.length}/${results.length}`
  );
  ...
  if (allRecipesResult && allRecipesResult.success) {
    ...
    console.log(
      `   @type array handling: ${allRecipesResult.features.hasTypeArray ? "✅" : "❌"}`
    );
    console.log(
      `   ImageObject URL extraction: ${allRecipesResult.features.hasImageObject ? "✅" : "❌"}`
    );
  }
