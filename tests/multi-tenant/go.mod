module recipe-archive/tests/multi-tenant
...
// Replace with local recipe-archive module
replace recipe-archive => ../../aws-backend/functions

replace recipe-archive/utils => ../../aws-backend/functions/utils
